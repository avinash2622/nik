...
<div id="intro-wrapper" class="wrapper wrapper-style1">
  ...
  <div class="5grid-layout">
	...
	<form:form method="post" action="signIn" modelAttribute="userRegistration">
                    <div class="5grid">
                      <div >
                        <div class="6u">
                          <input type="text" class="text" name="userRegEmail" id="contact-name" placeholder="UserName">
                        </div>
                        <div class="6u">
                          <input type="password" class="text" name="userRegPass" id="contact-email" placeholder="Password">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="12u">
                          <ul class="actions">
                            <li>
                              <input type="submit" class="button button-style1" value="Sign">
                            </li>
                            <li>
